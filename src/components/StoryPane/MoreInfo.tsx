...
const MoreInfo: React.FC = () => {
  ...
  return (
    <Wrapper>
        ...
        <p>If you have any feedback or questions about this website, I'd love to hear from you. I would also appreciate reports for any data inaccuracies. You may use this <StoryLink to="https://forms.gle/vrPuhXooxCL5Tvee6" text="Google form [NEED NEW FORM LINK]"></StoryLink> to get in touch.</p><Disclaimer><Link target="_blank" to="/privacy-policy" style={{ color: 'white' }}>Privacy Policy</Link></Disclaimer>
        <p>&nbsp;</p>
    </Wrapper>
  )
}
